...
export default function ArmyImporter() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold mb-4 text-[#C5A33E]">Army Importer</h2>
      ...
      <div className="space-y-4">
        <textarea
          ...
          className="w-full h-64 p-4 bg-[#14142a] border border-[#1a1a2e] rounded-lg text-gray-200 placeholder-gray-600 focus:outline-none focus:border-[#C5A33E] resize-none font-mono text-sm"
        />
      ...
      {parsedUnits.length > 0 && (
        <div className="mt-8">
          <h3 className="text-xl font-bold mb-4 text-[#C5A33E]">
          ...
          <div className="bg-[#14142a] border border-[#1a1a2e] rounded-lg p-4 space-y-2">
            {parsedUnits.map((unit, index) => (
              <div
                key={index}
                className="p-3 bg-[#0a0a14] border border-[#1a1a2e] rounded text-gray-200 hover:border-[#C5A33E] transition-colors"
              >
                {unit}
              </div>
            ))}
