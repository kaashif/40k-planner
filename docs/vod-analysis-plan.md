...
## 19 September continuation: fast melee

New user request supersedes the earlier two-additions stopping point. Added Yarin–Iyer (Blood Angels, 21 August 2026) and van der Most–Fritschen (Slaanesh Daemons, 14 August 2026), both 11th edition. Their dates are explicit on the homepage; they are new to the repo, not this week's broadcasts. Added 57 inspected timestamps, 16 chronological stills, 14 approximate maps and one partial broadcast roster card. Full public event lists subsequently recovered for both players and opponents; Yarin's large vehicle corrected to Defiler, not Mutalith. Added source-linked list summaries for the new games and Fowler's existing EC/Daemons reviews. No unverified starting reserve declarations added to the tally.

[Fast-melee study](fast-melee-vod-study.md) contains the army checklist, three-build roster comparison, practical positional lessons, game dates/editions, result reconciliation and search exclusions. A dated public inventory records 62 TS broadcast entries / 64 TS-side records, including losses, mirrors and possible duplicate coverage. World Eaters, Drukhari and Space Wolves outside-index candidates remain unverified, not claimed wins. New analysis separates visible evidence, interpretation, unknowns and confidence at each checkpoint; no transcript-derived actions after subtitle retrieval failed with HTTP 429.
